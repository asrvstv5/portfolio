...
const interests = [
  ...
  ['Distributed Systems & Cloud Infrastructure', Cloud], ['Software Reliability & Testing', Workflow], ['Human-AI Collaboration in Software Development', Sparkles]
] as const;

const projects = [
  { title: 'Copilot Plugin Management Platform', eyebrow: 'Microsoft · Power Automate', text: 'Led platform development for Microsoft Copilot plugin testing, enabling users to perform automation through Copilot’s chatbot and test Power Automate Connector Plugins.', tags: ['Power Automate', 'Copilot', 'REST APIs', 'Platform Engineering'] },
  { title: 'Horizon Avatar Editor', eyebrow: 'Meta · Full-Stack', text: 'Led development of the Horizon Avatar Editor Marketplace experience with React Native and GraphQL APIs, integrating recommendation and experimentation systems to improve personalization and engagement.', tags: ['React Native', 'TypeScript', 'GraphQL', 'Recommendations'] },
  { title: 'Live Playable In-line Ads', eyebrow: 'Meta · Family of Apps', text: 'Built backend APIs, in-game logging and interaction tracking, and deployment infrastructure for lightweight Horizon game experiences across Instagram, Facebook, and Horizon feeds.', tags: ['Backend APIs', 'Experimentation', 'Distributed Systems', 'Ads'] },
  { title: 'Dietmate', eyebrow: 'Independent · iOS App', text: 'Built a nutrition tracking application from scratch that uses AI-assisted food understanding to estimate calories and macronutrients, helping users understand and manage daily intake.', tags: ['SwiftUI', 'Python', 'Flask', 'MongoDB', 'AI'] }
];

export default function Home() {
  const personJsonLd = { '@context': 'https://schema.org', '@type': 'Person', name: 'Amitesh Srivastava', jobTitle: 'Software Engineer', url: 'https://amiteshsrivastava.com', sameAs: [linkedin, github], alumniOf: { '@type': 'CollegeOrUniversity', name: 'University of Illinois Urbana-Champaign' }, worksFor: { '@type': 'Organization', name: 'Meta' } };
  return <main><script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(personJsonLd) }} />
    <header className="nav"><div className="nav-inner"><a className="brand" href="#home">Amitesh Srivastava</a><nav>{['Home','About','Experience','Research','Projects','Writing','Contact'].map(x => <a key={x} href={`#${x.toLowerCase()}`}>{x}</a>)}</nav><div className="nav-social"><a href={linkedin} aria-label="LinkedIn"><Linkedin size={18}/></a><a href={github} aria-label="GitHub"><Github size={18}/></a><a href="mailto:amitesh.s.sr@gmail.com" aria-label="Email"><Mail size={18}/></a></div></div></header>
    ...
    <footer><div><strong>Amitesh Srivastava</strong><p>Building a more capable and productive future through technology.</p></div><div className="footer-right"><a href="#home">Home</a><a href="#about">About</a><a href="#experience">Experience</a><a href="#research">Research</a><a href="#projects">Projects</a><a href="#writing">Writing</a><a href="#contact">Contact</a><small>© 2026 Amitesh Srivastava. All rights reserved.</small></div></footer>
  </main>;
}
